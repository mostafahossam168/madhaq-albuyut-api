...
return [
    ...
    'attributes' => [
        ...
        'parent_name_en' => 'اسم الأب (إنجليزي)',
        'parent_name_ar' => 'اسم الأب (عربي)',
        'parent_email' => 'بريد الالكتروني ولي الامر',
        'parent_mobile' => 'رقم موبايل ولي الامر',
        'parent_date_birth' => 'تاريخ ميلاد ولي الامر',
        'parent_national_id' => 'رقم القمومي ولي الامر',
        'parent_address' => 'عنوان ولي الامر',
        'parent_job' => 'وظيفة ولي الامر',
        'parent_gender' => 'جنس ولي الامر',
        'child_name_en' => 'اسم الطفل (إنجليزي)',
        'child_name_ar' => 'اسم الطفل (عربي)',
        'child_date_birth' => 'تاريخ ميلاد الطفل',
        'child_gender' => 'جنس الطفل',
        'child_level' => 'مستوى الطفل',
        'child_school_name' => 'اسم مدرسة الطفل',
        'national_id' => 'الرقم القومي',
        'job' => 'الوظيفة',
        'date_birth' => 'تاريخ الميلاد',
        'message_otp' => ' الرمز التاكيدي',
        'parent_personal_identification' => 'صورة بطاقه الاب',
